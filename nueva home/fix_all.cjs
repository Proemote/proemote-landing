...
let p4End = html.indexOf('<!-- FINANCING BANNER -->', p4Start);
...
p4 = p4.replace(
    ...
    `</div>
                                ...
                                <p class="text-[11.5px] font-medium text-marca mt-3 text-center">🎁 Además: primer mes de gestión incluido — valorado en 499€ — sin coste.</p>
                            </div>
...
console.log("Successfully rebuilt index.html with accurate string replacements!");
